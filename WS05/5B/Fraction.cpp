...
int Fraction::gcd() const {
    ...
    Fraction operator+(const Fraction& lhs, const Fraction& rhs){
        if (rhs.numerator != 0 && rhs.denominator !=0 && lhs.numerator != 0 && lhs.denominator !=0){
            ...
            value1 = (lhs.numerator * rhs.denominator );   // left hand num * right hand denominator
            value2 = (lhs.denominator * rhs.numerator);    // left hand denominator * right hand numerator
            temp.denominator=  (lhs.denominator * rhs.denominator);   // * left and right denominators
    ...
    bool operator==(const Fraction& lhs,const Fraction& rhs) {
        if (lhs.numerator != 0 && lhs.denominator != 0){
            ...
            if((lhs.numerator == rhs.numerator) && (rhs.denominator == rhs.denominator)){
